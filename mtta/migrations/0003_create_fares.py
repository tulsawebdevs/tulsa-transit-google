...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm['mtta.fare'].objects.create(name='adult', cost='1.50')
        orm['mtta.fare'].objects.create(
            name='adult_express', cost='1.75', line_name_ipattern='express')

    def backwards(self, orm):
        orm['mtta.fare'].objects.filter(name='adult').delete()
        orm['mtta.fare'].objects.filter(name='adult_express').delete()
