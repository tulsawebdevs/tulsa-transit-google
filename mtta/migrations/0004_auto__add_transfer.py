...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mtta_transfer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('signup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mtta.SignUp'])),
            ('from_stop', self.gf('django.db.models.fields.related.ForeignKey')(related_name='transfer_from_stop', to=orm['mtta.Stop'])),
            ('to_stop', self.gf('django.db.models.fields.related.ForeignKey')(related_name='transfer_to_stop', to=orm['mtta.Stop'])),
        ...
        db.send_create_signal('mtta', ['Transfer'])


    def backwards(self, orm):
        # Deleting model 'Transfer'
        db.delete_table('mtta_transfer')
    ...
    models = {
        ...
        'mtta.transfer': {
            ...
            'from_stop': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'transfer_from_stop'", 'to': "orm['mtta.Stop']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'min_transfer_time': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'signup': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mtta.SignUp']"}),
            'to_stop': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'transfer_to_stop'", 'to': "orm['mtta.Stop']"}),
