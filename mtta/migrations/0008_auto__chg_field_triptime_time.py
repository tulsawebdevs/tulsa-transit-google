...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TripTime.time'
        db.alter_column(u'mtta_triptime', 'time', self.gf('django.db.models.fields.CharField')(max_length=6))

    def backwards(self, orm):

        # Changing field 'TripTime.time'
        db.alter_column(u'mtta_triptime', 'time', self.gf('django.db.models.fields.CharField')(max_length=5))
    ...
    models = {
        ...
        u'mtta.signup': {
            ...
            'feeds': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['multigtfs.Feed']", 'through': u"orm['mtta.SignupExport']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'mtta.triptime': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'time': ('django.db.models.fields.CharField', [], {'max_length': '6'}),
